      ...
      <div className="container mx-auto px-4 py-16">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl font-light text-[#1C1C1C] mb-4">
          ...
          <Card className="mb-8">
            <CardContent className="p-8">
              <h2 className="text-2xl font-light text-[#1C1C1C] mb-6">Dettagli Ordine</h2>
              
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  <h3 className="font-bold text-[#8B2E2E] mb-3">Informazioni Ordine</h3>
                  <div className="space-y-2 text-gray-700">
                    ...
                    <p><strong>Totale:</strong> <span className="font-bold text-[#8B2E2E]">€58.10</span></p>
                  </div>
                </div>
                
                <div>
                  <h3 className="font-bold text-[#8B2E2E] mb-3">Spedizione</h3>
                  <div className="space-y-2 text-gray-700">
          ...
          <Card className="mb-8">
            <CardContent className="p-8">
              <h2 className="text-2xl font-light text-[#1C1C1C] mb-6">Cosa Succede Ora?</h2>
              
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 bg-[#8B2E2E] rounded-full flex items-center justify-center flex-shrink-0">
          ...
          <div className="flex flex-col md:flex-row gap-4 justify-center">
            <Button className="bg-[#8B2E2E] hover:bg-[#A73939] text-white px-8 py-3 font-light">
              <Download className="h-4 w-4 mr-2" />
              Scarica Ricevuta
            </Button>
            
            <Link to="/shop/prodotti">
              <Button variant="outline" className="border-[#8B2E2E] text-[#8B2E2E] px-8 py-3 font-light">
          ...
          <Card className="mt-8">
            <CardContent className="p-8">
              <h2 className="text-2xl font-light text-[#1C1C1C] mb-6">Prodotti Ordinati</h2>
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between items-center pt-4">
                  ...
                  <p className="text-xl font-bold text-[#8B2E2E]">€58.10</p>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <div className="mt-12 text-center">
            ...
            <div className="grid md:grid-cols-2 gap-6 max-w-lg mx-auto">
              <Card className="p-4">
                <h4 className="font-bold text-[#8B2E2E] mb-2">Email</h4>
                <a href="mailto:info@houseofpulled.it" className="text-[#8B2E2E] hover:underline">
                  info@houseofpulled.it
                </a>
              </Card>
              
              <Card className="p-4">
                <h4 className="font-bold text-[#8B2E2E] mb-2">Telefono</h4>
                <a href="tel:+390357176614" className="text-[#8B2E2E] hover:underline">
                  +39 035 7176614
                </a>
              </Card>
            </div>
