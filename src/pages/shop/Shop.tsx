    ...
    <div className="min-h-screen">
      ...
      <section className="bg-gradient-to-r from-[#228B22] to-[#32CD32] text-white py-16">
        <div className="container mx-auto px-4 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-6">Shop House of Pulled</h1>
          ...
          <div className="flex flex-col md:flex-row gap-4 justify-center">
            <Link to="/shop/prodotti">
              <Button size="lg" className="bg-white text-[#228B22] hover:bg-gray-100 px-8 py-4">
                <ShoppingCart className="h-5 w-5 mr-2" />
                Scopri i Prodotti
              </Button>
            </Link>
            <Link to="/">
              <Button size="lg" variant="outline" className="border-white text-white hover:bg-white hover:text-[#228B22] px-8 py-4">
        ...
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-[#1C1C1C] mb-2">Spedizione Gratuita</h3>
              <p className="text-gray-600">Ordini sopra €50 spediti gratis in tutta Italia</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-[#1C1C1C] mb-2">Freschezza Garantita</h3>
              <p className="text-gray-600">Catena del freddo mantenuta fino alla consegna</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-[#1C1C1C] mb-2">Qualità Artigianale</h3>
              <p className="text-gray-600">Stessi prodotti serviti ai migliori ristoranti</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-[#1C1C1C] mb-2">Facile e Veloce</h3>
              <p className="text-gray-600">Ordina online, ricevi a casa in 24-48h</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-[#1C1C1C] mb-4">Prodotti in Evidenza</h2>
          ...
          <div className="text-center">
            <Link to="/shop/prodotti">
              <Button size="lg" className="bg-[#228B22] hover:bg-[#32CD32] text-white px-8 py-4">
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-[#1C1C1C] mb-4">Come Funziona</h2>
            <p className="text-xl text-gray-600">
              Semplice come 1, 2, 3
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-[#1C1C1C] mb-2">Scegli i Prodotti</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-[#1C1C1C] mb-2">Ordina Online</h3>
              <p className="text-gray-600">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-[#1C1C1C] mb-2">Ricevi e Gusta</h3>
              <p className="text-gray-600">
