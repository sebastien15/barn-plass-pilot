        ...
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col md:flex-row gap-6 justify-center items-center">
            <Link to="/catalogo-b2b">
              <Button size="lg" className="bg-[#8B2E2E] hover:bg-[#A73939] text-white px-8 py-4 text-lg">
                Esplora i nostri tagli
                <ArrowRight className="ml-2 h-5 w-5" />
              </Button>
            </Link>
            <Link to="/shop">
              <Button size="lg" variant="outline" className="border-white text-white hover:bg-white hover:text-[#8B2E2E] px-8 py-4 text-lg">
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
            ...
            {products.map((product, index) => (
              <Card key={index} className="border-2 border-[#8B2E2E] hover:shadow-lg transition-shadow">
                <CardContent className="p-6">
                  ...
                  <h3 className="text-xl font-bold text-[#8B2E2E] mb-2">{product.name}</h3>
          ...
          <div className="text-center">
            <Link to="/catalogo-b2b">
              <Button size="lg" className="bg-[#8B2E2E] hover:bg-[#A73939] text-white">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-[#1C1C1C] mb-2">Low & Slow</h3>
              <p className="text-gray-600">Cottura lenta a bassa temperatura per 12-16 ore</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-[#1C1C1C] mb-2">70 Giorni</h3>
              <p className="text-gray-600">Durata di conservazione con sottovuoto</p>
            </div>
          </div>
        </div>
      </section>
