  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-bold text-[#1C1C1C] mb-6">La Nostra Storia</h2>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-[#1C1C1C] mb-4">Visione e Missione</h2>
          </div>
          
          <div className="grid md:grid-cols-2 gap-8">
            <Card className="border-2 border-[#8B2E2E]">
              <CardContent className="p-8 text-center">
                <h3 className="text-2xl font-bold text-[#8B2E2E] mb-4">La Nostra Visione</h3>
                <p className="text-gray-700 text-lg">
            ...
            <Card className="border-2 border-[#8B2E2E]">
              <CardContent className="p-8 text-center">
                <h3 className="text-2xl font-bold text-[#8B2E2E] mb-4">La Nostra Missione</h3>
                <p className="text-gray-700 text-lg">
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-[#1C1C1C] mb-4">I Nostri Valori</h2>
          </div>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-[#1C1C1C] mb-2">Qualità</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-[#1C1C1C] mb-2">Tradizione</h3>
              <p className="text-gray-600">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-[#1C1C1C] mb-2">Sicurezza</h3>
              <p className="text-gray-600">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-[#1C1C1C] mb-2">Partnership</h3>
              <p className="text-gray-600">
